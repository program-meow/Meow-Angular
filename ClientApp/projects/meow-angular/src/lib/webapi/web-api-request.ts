...
export class WebApiRequest<T> {
   ...
   * @param message 消息操作
   */
  constructor(private request?: HttpRequest<Result<T>>, private meow?: Meow) {
  }
  ...
  private handleUnauthorize(options?: WebApiHandleOptions<T>) {
    ...
    this.meow.message.error(I18nKeys.unauthorizedMessage);
  }
